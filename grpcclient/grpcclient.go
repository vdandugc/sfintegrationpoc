...
import (
	...
	"example.com/sfintegrationpoc/oauth"
...
func (c *PubSubClient) Authenticate() error {
	...
	c.accessToken = common.AccessToken
	c.instanceURL = common.OAuthEndpoint
...
func (c *PubSubClient) Subscribe(replayPreset proto.ReplayPreset, replayId []byte, eventsChannel chan<- *proto.ConsumerEvent) ([]byte, error) {
